...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to homophone replacer lexicon",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Path to homophone replacer fst rules",
)
...
def main():
    ...
    if args.encoder:
        ...
        recognizer = sherpa_onnx.OnlineRecognizer.from_transducer(
            ...
            hr_rule_fsts=args.hr_rule_fsts,     # yong change, the code support it , but official example code not
            hr_lexicon=args.hr_lexicon,         # yong change
        )
